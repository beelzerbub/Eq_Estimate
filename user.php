		...
		<div class="row site_content">
			<div class="col-md-12">
				<div class="row site_content-filter">
							...
							<div class="col-md-5">
								<div class="row">
									<div class="col-md-3 col-md-offset-1">
										<button type="button" class="btn btn-primary" name="insert_user-link" id="insert_user-link" data-toggle="modal" data-target="#insert_user-box" value="insert_user">เพิ่มข้อมูลผู้ใช้</button>
									</div>
									<div class="col-md-3">
										<button type="button" class="btn btn-primary" name="user-link" id="user-link">
											หน้ารายชื่อผู้ใช้</button>
										</div>
										<div class="col-md-5">
											<button type="button" class="btn btn-primary" name="confirm_user-link" id="confirm_user-link">หน้ารายชื่อผู้ใช้ที่รอการอนุมัติ</button>
										</div>
									</div>
								</div>
							</fieldset>
									...
									<form action="#" role="form" method="post" data-toggle="validator" id="insert_user-form">
										<fieldset class="fieldset-form">
											...
											<div class="form-group">
												<div class="row">
													<div class="col-md-6">
														<input type="password" name="reg_password" id="reg_password" tabindex="1" class="form-control" data-error="กรุณาตรวจสอบความถูกต้อง" placeholder="รหัสผ่าน" value="" required>
					...
					<div class="row site_content-table"></div>
				</div>
			</div>
