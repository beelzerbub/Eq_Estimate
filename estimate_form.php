					...
					<div class="row site_content-menu">
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									<th></th>
									<th><center>ครูประจำชั้น</center></th>
									<th><center>ผู้ปกครอง</center></th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td style="vertical-align: middle">ขั้นตอนที่ 1 <br> ระบุผู้ให้การประเมิน</td>
								...
								<tr>
									<td style="vertical-align: middle">ดูผลการประเมิน</td>
									<td class="site_content-menu_box">
														...
														<table class="table table-bordered table-striped" id="compare-table_result">
															<thead>
																<tr>
																	...
																	<th><p class="text-center">ค่าเฉลี่ยในห้องเรียน <br> (ผลการประเมินจากครูประจำชั้น)</p></th>
																	<th><p class="text-center">ค่าเฉลี่ยในห้องเรียน <br> (ผลการประเมินจากผู้ปกครอง)</p></th>
																</tr>
															</thead>
															<tbody>
																<?php
																...
																while($group = mysql_fetch_array($groups)) {
																	...
																	<tr>
																		...
																		<td>
																			<center>
																				<?php
																				echo get_average_estimate($student_fetch->Std_no, $student_fetch->Term, $student_fetch->Term_year, $group['Sg_id'] , "ครูประจำชั้น");	
																				?>
																			</center>
																		</td>
																		<td>
																			<center>
																				<?php
																				echo get_average_estimate($student_fetch->Std_no, $student_fetch->Term, $student_fetch->Term_year, $group['Sg_id'] , "ผู้ปกครอง");	
																				?>
																			</center>
																		</td>
																	</tr>
														...
														<table class="table table-bordered table-striped" id="compare_tscore-table_result">
															<thead>
																<tr>
																	...
																	<th><p class="text-center">ครูประจำชั้น</p></th>
																	<th><p class="text-center">ผู้ปกครอง</p></th>
																	<th><p class="text-center">เฉลี่ยในห้องเรียน <br> (ผลการประเมินจากครูประจำชั้น)</p></th>
																	<th><p class="text-center">เฉลี่ยในห้องเรียน <br> (ผลการประเมินจากผู้ปกครอง)</p></th>
																</tr>
															</thead>
															<tbody>
																<?php
																...
																while($group = mysql_fetch_array($groups)) {
																	...
																	<tr>
																		...
																		<td>
																			<center>
																				<?php 
																				echo get_average_t_score($student_fetch->Std_no, $student_fetch->Term, $student_fetch->Term_year, $group['Sg_id'] , "ครูประจำชั้น");
																				?>
																			</center>
																		</td>
																		<td>
																			<center>
																				<?php 
																				echo get_average_t_score($student_fetch->Std_no, $student_fetch->Term, $student_fetch->Term_year, $group['Sg_id'] , "ผู้ปกครอง");
																				?>
																			</center>
																		</td>
																	</tr>
													...
													<div class="col-md-9">
														...
														<table class="table table-bordered table-striped" id="compare_guide">
															...
															for ($i = 1; $i <= 8; $i++) {
																...
																<tr>
																	<td>
																		<li class="list-group-item compare_list">
																			<?php
																			if ($i == 1) {
																				if (compare_score($teacher_guide_score, $parent_guide_score) == 1) {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านควบคุมอารมณ์<span class='compare_list-highest'>ที่บ้านมีค่าคะแนนการประเมินน้อยกว่าที่โรงเรียน</span>";
																				} else if (compare_score($teacher_guide_score, $parent_guide_score) == 2){
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านควบคุมอารมณ์<span class='compare_list-lowest'>ที่บ้านมีค่าคะแนนการประเมินมากกว่าที่โรงเรียน";
																				} else {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านควบคุมอารมณ์<span class='compare_list-match'>ที่บ้านและที่โรงเรียนมีคะแนนการประเมินเท่ากัน</span>";
																				}
																			} else if ($i == 2){
																				if (compare_score($teacher_guide_score, $parent_guide_score) == 1) {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านใส่ใจและเข้าใจอารมณ์<span class='compare_list-highest'>ที่บ้านมีค่าคะแนนการประเมินน้อยกว่าที่โรงเรียน</span>";
																				} else if (compare_score($teacher_guide_score, $parent_guide_score) == 2){
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านใส่ใจและเข้าใจอารมณ์<span class='compare_list-lowest'>ที่บ้านมีค่าคะแนนการประเมินมากกว่าที่โรงเรียน</span>";
																				} else {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านใส่ใจและเข้าใจอารมณ์<span class='compare_list-match'>ที่บ้านและที่โรงเรียนมีคะแนนการประเมินเท่ากัน</span>";
																				}
																			} else if ($i == 3){
																				if (compare_score($teacher_guide_score, $parent_guide_score) == 1) {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านยอมรับถูกผิด<span class='compare_list-highest'>ที่บ้านมีค่าคะแนนการประเมินน้อยกว่าที่โรงเรียน</span>";
																				} else if (compare_score($teacher_guide_score, $parent_guide_score) == 2){
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านยอมรับถูกผิด<span class='compare_list-lowest'>ที่บ้านมีค่าคะแนนการประเมินมากกว่าที่โรงเรียน</span>";
																				} else {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านใส่ยอมรับถูกผิด<span class='compare_list-match'>ที่บ้านและที่โรงเรียนมีคะแนนการประเมินเท่ากัน</span>";
																				}
																			} else if ($i == 4) {
																				if (compare_score($teacher_guide_score, $parent_guide_score) == 1) {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านมุ่งมั่นพยายาม<span class='compare_list-highest'>ที่บ้านมีค่าคะแนนการประเมินน้อยกว่าที่โรงเรียน</span>";
																				} else if (compare_score($teacher_guide_score, $parent_guide_score) == 2){
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านมุ่งมั่นพยายาม<span class='compare_list-lowest'>ที่บ้านมีค่าคะแนนการประเมินมากกว่าที่โรงเรียน</span>";
																				} else {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านมุ่งมั่นพยายาม<span class='compare_list-match'>ที่บ้านและที่โรงเรียนมีคะแนนการประเมินเท่ากัน</span>";
																				}
																			} else if ($i == 5) {
																				if (compare_score($teacher_guide_score, $parent_guide_score) == 1) {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านปรับตัวต่อปัญหา<span class='compare_list-highest'>ที่บ้านมีค่าคะแนนการประเมินน้อยกว่าที่โรงเรียน</span>";
																				} else if (compare_score($teacher_guide_score, $parent_guide_score) == 2){
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านปรับตัวต่อปัญหา<span class='compare_list-lowest'>ที่บ้านมีค่าคะแนนการประเมินมากกว่าที่โรงเรียน</span>";
																				} else {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านปรับตัวต่อปัญหา<span class='compare_list-match'>ที่บ้านและที่โรงเรียนมีคะแนนการประเมินเท่ากัน</span>";
																				}
																			} else if ($i == 6) {
																				if (compare_score($teacher_guide_score, $parent_guide_score) == 1) {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านกล้าแสดงออก<span class='compare_list-highest'>ที่บ้านมีค่าคะแนนการประเมินน้อยกว่าที่โรงเรียน</span>";
																				} else if (compare_score($teacher_guide_score, $parent_guide_score) == 2){
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านกล้าแสดงออก<span class='compare_list-lowest'>ที่บ้านมีค่าคะแนนการประเมินมากกว่าที่โรงเรียน</span>";
																				} else {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านกล้าแสดงออก<span class='compare_list-match'>ที่บ้านและที่โรงเรียนมีคะแนนการประเมินเท่ากัน</span>";
																				}
																			} else if ($i == 7) {
																				if (compare_score($teacher_guide_score, $parent_guide_score) == 1) {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านพอใจในตนเอง<span class='compare_list-highest'>ที่บ้านมีค่าคะแนนการประเมินน้อยกว่าที่โรงเรียน</span>";
																				} else if (compare_score($teacher_guide_score, $parent_guide_score) == 2){
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านพอใจในตนเอง<span class='compare_list-lowest'>ที่บ้านมีค่าคะแนนการประเมินมากกว่าที่โรงเรียน</span>";
																				} else {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านพอใจในตนเองก<span class='compare_list-match'>ที่บ้านและที่โรงเรียนมีคะแนนการประเมินเท่ากัน</span>";
																				}
																			} else if ($i == 8) {
																				if (compare_score($teacher_guide_score, $parent_guide_score) == 1) {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านรู้จักปรับตัว<span class='compare_list-highest'>ที่บ้านมีค่าคะแนนการประเมินน้อยกว่าที่โรงเรียน</span>";
																				} else if (compare_score($teacher_guide_score, $parent_guide_score) == 2){
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านรู้จักปรับตัว<span class='compare_list-lowest'>ที่บ้านมีค่าคะแนนการประเมินมากกว่าที่โรงเรียน</span>";
																				} else {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านรู้จักปรับตัว<span class='compare_list-match'>ที่บ้านและที่โรงเรียนมีคะแนนการประเมินเท่ากัน</span>";
																				}
																			} else if ($i == 9) {
																				if (compare_score($teacher_guide_score, $parent_guide_score) == 1) {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านรื่นเริงเบิกบาน<span class='compare_list-highest'>ที่บ้านมีค่าคะแนนการประเมินน้อยกว่าที่โรงเรียน</span>";
																				} else if (compare_score($teacher_guide_score, $parent_guide_score) == 2){
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านรื่นเริงเบิกบาน<span class='compare_list-lowest'>ที่บ้านมีค่าคะแนนการประเมินมากกว่าที่โรงเรียน</span>";
																				} else {
																					echo "ค่าความฉลาดทางอารมณ์ทางด้านรื่นเริงเบิกบาน<span class='compare_list-match'>ที่บ้านและที่โรงเรียนมีคะแนนการประเมินเท่ากัน</span>	";
																				}
																			}
																			?>
																		</li>
